...
@section('content')
    <div class="max-w-5xl mx-auto px-4 py-12">
        <a href="{{ route('public.index') }}"
            class="inline-flex items-center text-sm text-slate-400 hover:text-blue-600 mb-10 transition-colors">
        ...
        <div class="grid lg:grid-cols-12 gap-12 items-start">
            ...
            <div class="lg:col-span-5 space-y-8">
                <div>
                    <span
                        class="text-[10px] font-bold tracking-[0.2em] uppercase text-blue-600 bg-blue-50 px-3 py-1 rounded-full">

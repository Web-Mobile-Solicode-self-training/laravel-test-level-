    ...
    <div class="bg-gradient-to-b from-slate-50 to-white min-h-screen">
        <div class="max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 lg:py-20 mx-auto">
            ...
            <div class="max-w-3xl mb-12">
                <span
                    class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-blue-100 text-blue-800 mb-4">
                ...
                <p class="mt-4 text-lg text-slate-600 leading-relaxed">
                    Explorez les défis technologiques et les projets personnels prévus pour cette année. Chaque carte
                    représente une étape vers l'excellence.
                </p>
            </div>
                    ...
                    <div
                        ...
                        <div class="relative aspect-[16/10] overflow-hidden">
                            ...
                            <div class="absolute bottom-4 right-4">
                                ...
                                @endphp
                                <span
                                    class="{{ $bgColor }} text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase shadow-lg">
                        ...
                        <div class="p-6">
                            <h3
                                class="text-xl font-bold text-slate-800 group-hover:text-blue-600 transition-colors duration-300">
                                {{ $goal->title }}
                            </h3>

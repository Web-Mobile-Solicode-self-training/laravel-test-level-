...
<body class="bg-slate-50 h-full font-sans text-slate-900">
    ...
    <header
        class="sticky top-0 z-50 flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white/80 backdrop-blur-md border-b border-slate-200">
        <nav class="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between py-3"
            aria-label="Global">

            <div class="flex items-center justify-between">
                <a class="flex items-center gap-x-2 text-2xl font-black text-blue-600 tracking-tight"
                    href="{{ route('index') }}">
                ...
                <div class="sm:hidden">
                    <button type="button"
                        class="hs-collapse-toggle p-2 inline-flex justify-center items-center gap-2 rounded-lg border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm"
            ...
            <div id="navbar-collapse-basic"
                ...
                <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
                    ...
                    <a class="flex items-center gap-x-2 font-semibold {{ Route::is('index') ? 'text-blue-600' : 'text-slate-600 hover:text-blue-600' }} transition-colors"
                        href="{{ route('index') }}">
